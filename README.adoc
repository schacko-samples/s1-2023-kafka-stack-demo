...
This demo repository goes along with the talk https://springone.io/sessions/walking-through-the-spring-stack-for-apache-kafka[Walking through the Spring Stack for Apache Kafka].
